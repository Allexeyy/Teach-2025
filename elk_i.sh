...
cp /home/alexey/repo/jvm.options /etc/elasticsearch/jvm.options.d/jvm.options

#Устновка ElasticSearch и копирование его конфига
sudo dpkg -i elasticsearch-8.9.1-amd64.deb
cp /home/alexey/repo/elasticsearch.yml /etc/elasticsearch/elasticsearch.yml
sudo systemctl daemon-reload
sudo systemctl enable --now elasticsearch.service

#Устновка Kibana и копирование его конфига
sudo dpkg -i kibana-8.9.1-amd64.deb
cp /home/alexey/repo/kibana.yml /etc/kibana/kibana.yml
sudo systemctl daemon-reload
...
cp /home/alexey/repo/logstash/logstash.yml /etc/logstash/logstash.yml
cp /home/alexey/repo/logstash-nginx-es.conf /etc/logstash/conf.d/logstash-nginx-es.conf
